    ...
    <div class="col-lg-4 col-md-6">
      <div class="card">
        <div class="card-body text-center">
          ...
          <h3 class="text-warning"><?= format_naira($inv['cost_val']) ?></h3>
          <?php if ($inv['missing_cost_count'] > 0): ?>
          <small class="text-danger font-weight-bold d-block mt-1"><?= (int)$inv['missing_cost_count'] ?> item(s) missing cost</small>
          <?php else: ?>
          <small class="text-muted d-block mt-1"><?= number_format($inv['units']) ?> units in stock</small>
          <?php endif; ?>
        </div>
      </div>
    </div>
    <div class="col-lg-4 col-md-6">
      <div class="card">
        <div class="card-body text-center">
          ...
          <small class="text-danger font-weight-bold d-block mt-1"><?= (int)$inv['missing_retail_count'] ?> item(s) missing price</small>
          <?php else: ?>
          <small class="text-muted d-block mt-1">Potential revenue if all sold</small>
          <?php endif; ?>
        </div>
      </div>
    </div>
